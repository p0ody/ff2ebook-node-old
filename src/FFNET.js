...
{
    var self = this;
    Async.times(this.chapterCount, function(i, next)
    {
...
FFNET.prototype.findTitle = function(source)
{
    ...
    if (matches === null)
    {
        this.event.emit("warning", "Coulnd't find fic title.");
        return "Untitled";
    }
...
FFNET.prototype.findAuthor = function(source)
{
    ...
    if (matches === null)
    {
        this.event.emit("warning", "Coulnd't find fic author.");
...
FFNET.prototype.findFicType = function(source)
{
    ...
    if (matches === null)
    {
        this.event.emit("warning", "Coulnd't find fic type.");
        return false;
    }
...
FFNET.prototype.findFandom = function(source)
{
    ...
    if (matches === null)
    {
        this.event.emit("warning", "Coulnd't find fic fandom.");
        return false;
    }
...
FFNET.prototype.findSummary = function(source)
{
    ...
    if (matches === null)
    {
        this.event.emit("warning", "Coulnd't find fic summary.");
        return false;
    }
...
FFNET.prototype.findPublishedDate = function(source)
{
    ...
    if (matches === null)
    {
        this.event.emit("warning", "Coulnd't find fic published date.");
        return false;
    }
...
FFNET.prototype.findUpdatedDate = function(source)
{
    ...
    if (matches === null)
    {
        this.event.emit("warning", "Coulnd't find fic last updated date.");
...
FFNET.prototype.findPairing = function(source)
{
    ...
    if (matches === null)
    {
        this.event.emit("warning", "Coulnd't find fic pairing.");
        return false;
    }
...
FFNET.prototype.gatherFicInfos = function(callback)
{
...
FFNET.prototype.gatherChaptersInfos = function(callback)
{
